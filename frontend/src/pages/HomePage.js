...
const HomePage = () => {
  ...
  return (
    <div style={{ backgroundColor: '#F0F0F0' }}>
      {/* Hero Section */}
      <section ref={heroRef} className="relative h-screen overflow-hidden" style={{ backgroundColor: '#F0F0F0' }}>
        {/* Animated Background */}
        <div 
          ...
          <div className="absolute inset-0" style={{ backgroundColor: '#F0F0F0' }}>
            ...
            <div 
              ...
              style={{
                width: '500px',
                height: '500px',
                background: 'linear-gradient(135deg, #C5C5C5 0%, #9E9E9E 100%)',
                bottom: '15%',
                right: '10%',
          ...
          <div className={`text-center max-w-5xl transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <h1 className="text-6xl md:text-8xl font-bold mb-8 leading-tight">
              <span 
                ...
                style={{ 
                  backgroundImage: 'linear-gradient(135deg, #4A4A4A 0%, #6B6B6B 50%, #8C8C8C 100%)',
            ...
            <div className="flex flex-wrap gap-6 justify-center items-center">
              <button 
                ...
                style={{ 
                  ...
                  color: '#FFFFFF',
                  boxShadow: '0 10px 40px rgba(90, 90, 90, 0.3)'
                }}
              >
            ...
            <div className="flex flex-wrap gap-12 justify-center mt-16 pt-8" style={{ borderTop: '1px solid rgba(0, 0, 0, 0.1)' }}>
              {[
                ...
                >
                  <div className="text-4xl font-bold" style={{ color: '#3A3A3A' }}>{stat.value}</div>
                  <div className="mt-1" style={{ color: '#000000' }}>{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce">
          <svg className="w-6 h-6" style={{ color: '#5A5A5A' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Features Section */}
      <section id="features" className="relative py-32" style={{ backgroundColor: '#FAFAFA' }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-20">
            <span className="font-semibold text-sm uppercase tracking-wider" style={{ color: '#5A5A5A' }}>Our Features</span>
            <h2 className="text-5xl md:text-6xl font-bold mt-4 mb-6" style={{ color: '#000000' }}>
            ...
            {[
              {
                ...
                gradient: "linear-gradient(135deg, #D1D1D1 0%, #B8B8B8 100%)"
              },
              {
                ...
                gradient: "linear-gradient(135deg, #C5C5C5 0%, #ABABAB 100%)"
              },
              {
                ...
                gradient: "linear-gradient(135deg, #A8A8A8 0%, #8E8E8E 100%)"
              }
            ].map((feature, index) => (
              <div 
                key={index}
      ...
      <section id="how-it-works" className="relative py-32 overflow-hidden" style={{ backgroundColor: '#F0F0F0' }}>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            <span className="font-semibold text-sm uppercase tracking-wider" style={{ color: '#5A5A5A' }}>Simple Process</span>
            <h2 className="text-5xl md:text-6xl font-bold mt-4 mb-6" style={{ color: '#000000' }}>
              How It Works
            </h2>
          </div>
              ...
              >
                <div 
                  ...
                  style={{ 
                    ...
                    boxShadow: '0 10px 30px rgba(90, 90, 90, 0.3)'
                  }}
                >
                ...
                {index < 3 && (
                  <div className="hidden md:block absolute top-10 left-[60%] w-[80%] h-0.5" style={{ backgroundColor: 'rgba(0, 0, 0, 0.15)' }} />
                )}
              </div>
            ))}
          </div>
      ...
      {/* CTA Section */}
      <section className="relative py-32 overflow-hidden" style={{ backgroundColor: '#FAFAFA' }}>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-xl mb-12" style={{ color: '#000000' }}>
          ...
          <button 
            ...
            style={{ 
              backgroundColor: '#5A5A5A',
              color: '#FFFFFF',
              boxShadow: '0 10px 40px rgba(90, 90, 90, 0.4)'
            }}
          >
            Get Started Now
      ...
      {/* Footer */}
      <footer className="border-t py-12" style={{ backgroundColor: '#F0F0F0', borderColor: 'rgba(0, 0, 0, 0.1)' }}>
        <div className="max-w-7xl mx-auto px-6 text-center" style={{ color: '#000000' }}>
